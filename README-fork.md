...
Ninguna de las cuatro está fusionada en `master` todavía. Cada branch
parte del mismo commit base (`db2e4199`, que ya incluye las correcciones
al pipeline de build de Linux — ver más abajo).
